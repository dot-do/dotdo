...
/**
 * Minimal SqlStorage interface for revocation store
 * Compatible with @dotdo/db SqlStorage without importing it
 */
...
/**
 * SQL statement interface for executing queries
 */
export interface SqlStorageStatement {
