 ...
 * @internal
 */
export async function generateHmacSignature(secret, sourceDoId, timestamp, targetPath) {
 ...
 * @internal
 */
export async function verifyHmacSignature(secret, sourceDoId, timestamp, signature, targetPath) {
    try {
 ...
 */
export async function verifyDOSignature(request, logger) {
    if (!doInternalSecret) {
 ...
 */
export async function addDOSourceHeaders(headers, sourceDoId, targetPath, logger) {
 ...
 * ```
 */
export async function addDOSourceHeadersAsync(headers, sourceDoId, targetPath, logger) {
 ...
 * ```
 */
export async function createDOToDoHeaders(sourceDoId, targetPath, correlationId, logger) {
    const timestamp = Date.now().toString();
...
//# sourceMappingURL=do-signing.js.map