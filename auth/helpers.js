...
import { MissingTokenError, InvalidAuthHeaderError, } from './errors';
/**
 ...
 */
export function extractBearerTokenFromHeader(authHeader) {
    if (!authHeader) {
        return {
            token: null,
 ...
 */
export function extractTokenFromCookie(cookieHeader, cookieName) {
 ...
 * @returns Result with token and optional error details
 */
export function extractBearerToken(request, cookieName) {
