 ...
 *
 * Note: OpenAPI-based SDK generation is tested separately in sdk-openapi.test.ts
 */
...
describe('api/sdk.ts - SDK Generation', () => {
  ...
  // Note: OpenAPI-based SDK generation (generateSDKFromOpenAPI, SDKFromOpenAPIGenerator)
  // is comprehensively tested in sdk-openapi.test.ts
})
