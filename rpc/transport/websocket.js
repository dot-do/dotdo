...
import { createNetworkError, createTimeoutError, createErrorContext, applyErrorInterceptor, } from './error-utils';
import { DEFAULT_RPC_TIMEOUT_MS, DEFAULT_RECONNECT_DELAY_MS, DEFAULT_MAX_RECONNECT_DELAY_MS, DEFAULT_MAX_RECONNECT_ATTEMPTS, } from '@dotdo/utils';
/**
...
export class WebSocketTransport {
     ...
     */
    sendSubscriptionMessage(message, subscriptionId) {
        return new Promise((resolve, reject) => {
            if (!this.ws || this.ws.readyState !== WebSocket.OPEN) {
