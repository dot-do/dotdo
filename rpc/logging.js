 ...
 */
export function buildErrorContext(error, method, args, correlationId) {
    const context = {
        method,
    ...
    if (error instanceof Error) {
        ...
        if ('details' in error && typeof error.details === 'object') {
            context.details = sanitizeValue(error.details);
        }
    }
    return context;
}
 ...
 */
export function logRPCError(error, method, args, correlationId) {
 ...
 */
export function formatErrorContext(context) {
    const parts = [
