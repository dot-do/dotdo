...
export class Business extends DO {
  ...
  constructor(
    ...
    // DurableObjectState and Record<string, unknown> are compatible with DO's constructor
    // The DO base class expects DurableObjectState and DOEnv (which extends Record<string, unknown>)
    super(state, env)
