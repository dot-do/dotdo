...
describe('README Examples Verification', () => {
  ...
  describe('@dotdo/ai', () => {
    ...
    it('exports caching utilities', async () => {
      const aiModule = await import('@dotdo/ai')

      // README Example: Caching
      expect(aiModule.GenerationCache).toBeDefined()
      expect(aiModule.EmbeddingCache).toBeDefined()
      expect(aiModule.MemoryCache).toBeDefined()
    })
