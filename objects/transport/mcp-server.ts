...
import type {
  ...
  ToolThingData as ToolThingDataType,
  ToolQuery as ToolQueryType,
} from '../../types/mcp'
...
import {
  ...
  toolThingToMcp as mcpToolThingToMcp,
} from '../../types/mcp'
...
// ============================================================================
// GRAPH INTEGRATION - Types re-exported from types/mcp.ts
// ============================================================================

/**
 * @deprecated Import from types/mcp.ts instead
 */
export type ToolParameter = ToolParameterType

/**
 * @deprecated Import from types/mcp.ts instead
 */
export type ToolThingData = ToolThingDataType
 ...
 * @deprecated Import from types/mcp.ts instead
 */
export const toolThingToMcp = mcpToolThingToMcp
