/**
 * RED TDD: withBash Capability Integration Tests
 *
 * These tests verify the withBash capability integration with bashx.do:
 *
 * Key requirements:
...
// Import the capabilities we're testing
...
describe('withBash Capability - Dependency Requirements', () => {
...
describe('withBash Capability - Tagged Template Support', () => {
  let instance: any
...
describe('withBash Capability - Variable Interpolation & Safety', () => {
  let instance: any
...
describe('withBash Capability - Dangerous Command Rejection', () => {
  let instance: any
  let mockExecutor: ReturnType<typeof createMockExecutor>
...
describe('withBash Capability - $.bash.exec() Raw Execution', () => {
  let instance: any
  let mockExecutor: ReturnType<typeof createMockExecutor>
...
describe('withBash Capability - Filesystem Integration', () => {
  let instance: any
  let mockExecutor: ReturnType<typeof createMockExecutor>
...
describe('withBash Capability - Classification Metadata', () => {
  let instance: any
...
describe('withBash Capability - Type Safety', () => {
...
describe('withBash Capability - Additional APIs', () => {
  let instance: any
  let mockExecutor: ReturnType<typeof createMockExecutor>
