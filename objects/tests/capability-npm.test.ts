/**
 * RED TDD: withNpm Capability Integration Tests
 *
 * Tests for integrating npmx.do's withNpm capability with dotdo Durable Objects.
...
describe('withNpm Capability - Dependency Requirements', () => {
...
describe('withNpm Capability - Capability Detection', () => {
...
describe('withNpm Capability - $.npm.resolve()', () => {
...
describe('withNpm Capability - $.npm.install()', () => {
  let instance: InstanceType<ReturnType<typeof withNpm<ReturnType<typeof withFs<typeof DO>>>>>
...
describe('withNpm Capability - $.npm.lockfile()', () => {
  let instance: InstanceType<ReturnType<typeof withNpm<ReturnType<typeof withFs<typeof DO>>>>>
...
describe('withNpm Capability - $.npm.list()', () => {
  let instance: InstanceType<ReturnType<typeof withNpm<ReturnType<typeof withFs<typeof DO>>>>>
...
describe('withNpm Capability - $.npm.run()', () => {
...
describe('withNpm Capability - $.npm.pack()', () => {
  let instance: InstanceType<ReturnType<typeof withNpm<ReturnType<typeof withFs<typeof DO>>>>>
...
describe('withNpm Capability - Type Safety', () => {
...
describe('withNpm Capability - Composition', () => {
