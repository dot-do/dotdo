 ...
 *
 * RED TDD: These tests define the expected interface for capabilities:
 ...
 *
 * Capabilities extend the base DO class and augment the WorkflowContext ($) with
 * additional features. They can be composed using standard composition patterns:
 *
 * ```typescript
 ...
 * - Capability function existence and exports
 * - Type definitions and interfaces
 * - Capability composition patterns (conceptually)
...
// Import capabilities from lib/capabilities which is the primary location
import {
  withFs,
  withGit,
  withBash,
...
describe('Capability Composition', () => {
  ...
  describe('Capability Composition Types', () => {
