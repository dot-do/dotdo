 ...
 *
 * Drop-in replacement for pusher-js backed by DO with in-memory pub/sub.
...
class ConnectionImpl extends EventEmitter implements IConnection {
...
class ChannelImpl extends EventEmitter implements IChannel {
  name: string
...
class UserDataImpl extends EventEmitter implements IUserData {
  id?: string
  ...
  private _watchlistEmitter = new EventEmitter()
...
class PusherImpl extends EventEmitter implements IPusher {
