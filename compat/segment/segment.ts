...
export class Analytics {
  ...
  private buildEvent(
    ...
    for (const middleware of this.sourceMiddlewares) {
      ...
      if (result === null) {
        // Event dropped by middleware - we need to handle this case
        // For now, return the event but mark it for dropping
