...
export class MailResource extends SendGridResource {
  ...
  async send(data: MailData, options?: RequestOptions): Promise<MailSendResponse> {
    ...
    const response = await this.client._sendRaw('/v3/mail/send', request, options)
