...
/**
 * Experiment result for a user
 */
export interface ExperimentResult {
  experimentKey: string
  variantId: string
  variantValue: LDFlagValue
  inExperiment: boolean
}
...
/**
 * Summary event (batched evaluations)
 */
...
/**
 * Feature summary within a summary event
 */
...
/**
 * Counter within a feature summary
 */
 ...
 */
export type LDEvent = FeatureEvent | CustomEvent | IdentifyEvent | SummaryEvent
...
/**
 * Evaluation statistics for a flag
 */
