/**
 * Zapier Compatibility Layer Tests
 *
 * Comprehensive tests for zapier-platform-core compatible automation:
...
describe('Zapier Compatibility Layer', () => {
  beforeEach(() => {
    vi.useFakeTimers()
  })
  ...
  describe('Triggers', () => {
    ...
    describe('PollingTriggerExecutor', () => {
      it('should deduplicate across multiple polls', async () => {
        ...
        const trigger = new Trigger(config)
        const executor = new PollingTriggerExecutor(trigger, 'id')
        const z = createZObject()
  ...
  describe('Actions', () => {
    ...
    it('should validate required input', () => {
      ...
      const result = action.validateInput({ other_field: 'value' })
  ...
  describe('Webhook', () => {
    ...
    describe('WebhookSubscriptionManager', () => {
      it('should manage subscriptions', async () => {
        ...
        const trigger: HookTriggerConfig = {
          key: 'test',
          noun: 'Test',
          display: { label: 'Test', description: 'Test' },
          operation: {
