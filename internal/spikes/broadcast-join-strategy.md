...
- [Cross-DO Join Latency](./cross-do-join-latency.md) - Foundation for latency budgets used in this analysis
- [Distributed Checkpoint Coordination](./distributed-checkpoint-coordination.md) - Coordinating state across DOs during joins
- [Checkpoint Size Limits](./checkpoint-size-limits.md) - Memory constraints for broadcast data
- [Memory Limits Intermediate Results](./memory-limits-intermediate-results.md) - Managing intermediate join results
