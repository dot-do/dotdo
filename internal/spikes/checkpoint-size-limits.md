...
- [Distributed Checkpoint Coordination](./distributed-checkpoint-coordination.md) - Coordinating checkpoints across multiple DOs
- [Exactly-Once Hibernation](./exactly-once-hibernation.md) - Checkpoint strategies for hibernation recovery
- [Cross-DO Join Latency](./cross-do-join-latency.md) - Performance constraints affecting checkpoint timing
- [State Recovery Latency](./state-recovery-latency.md) - Recovery strategies using checkpoints

### Related Architecture Documents

- [Architecture Overview](../architecture.md) - Main architecture documentation
- [DOBase Decomposition](../architecture/dobase-decomposition.md) - Module extraction affecting checkpoint boundaries
