---
title: "@dotdo/cohere"
description: Drop-in replacement for the Cohere SDK with edge compatibility, streaming support, and zero dependencies.
---
...
<Callout type="info">
Looking for a managed service? See [cohere.do](/docs/integrations/cohere/service) for production deployments with built-in key management and analytics.
</Callout>

## Why @dotdo/cohere?

| Cohere SDK | @dotdo/cohere |
|------------|---------------|
...
## Testing with @dotdo/cohere

The package is ideal for unit testing AI features:
...
describe('AIService', () => {
  ...
  it('should generate text', async () => {
    ...
    expect(response.generations[0].text).toBe('Mocked response')
  })
})
```
...
- [cohere.do](/docs/integrations/cohere/service) - Managed Cohere service
