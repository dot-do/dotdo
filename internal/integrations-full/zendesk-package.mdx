...
<Callout type="info">
Looking for a managed support platform without Zendesk infrastructure? See [zendesk.do](/docs/integrations/zendesk/service) for a fully managed Zendesk-compatible service on the edge.
</Callout>
...
- [zendesk.do](/docs/integrations/zendesk/service) - Managed Zendesk-compatible support on the edge
