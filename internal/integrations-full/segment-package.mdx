...
<Callout type="info">
Looking for managed analytics without infrastructure? See [segment.do](/docs/integrations/segment/service) for a fully managed Segment-compatible service on the edge.
</Callout>
...
## Local Mode - Testing with InMemoryTransport
...
## Production Mode - Connecting to Real Segment
...
## Testing with @dotdo/segment

@dotdo/segment is ideal for unit tests - no external Segment required:
...
- [segment.do](/docs/integrations/segment/service) - Managed Segment-compatible analytics
