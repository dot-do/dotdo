...
[dotdo API Reference](../../README.md) / [objects](../README.md) / Agent

# Class: Agent

Defined in: [objects/Agent.ts:195](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L195)
...
> **new Agent**(`ctx`, `env`): `Agent`

Defined in: [objects/Agent.ts:207](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L207)
...
> `protected` **act**(`action`): `Promise`\<`void`\>

Defined in: [objects/Agent.ts:347](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L347)
...
Defined in: [objects/Agent.ts:430](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L430)
...
> **executeTool**(`name`, `input`): `Promise`\<`unknown`\>

Defined in: [objects/Agent.ts:262](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L262)
...
Defined in: [objects/DOTiny.ts:460](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/DOTiny.ts#L460)
...
Defined in: [objects/Agent.ts:438](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L438)
...
Defined in: [objects/Agent.ts:472](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L472)
...
> **getMemory**(): [`AgentMemory`](../../agents/interfaces/AgentMemory.md) \| `undefined`

Defined in: [objects/Agent.ts:234](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L234)

Get the unified memory system, if set.

#### Returns

[`AgentMemory`](../../agents/interfaces/AgentMemory.md) \| `undefined`
...
> **getRecentMemories**(`limit`): `Promise`\<[`Memory`](../interfaces/Memory.md)[]\>

Defined in: [objects/Agent.ts:384](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L384)
...
> **getTools**(): [`Tool`](../interfaces/Tool.md)[]

Defined in: [objects/Agent.ts:255](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L255)
...
Defined in: [objects/Agent.ts:241](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L241)
...
Defined in: [objects/Agent.ts:447](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L447)
...
> `protected` **observe**(`goal`): `Promise`\<`Record`\<`string`, `unknown`\>\>

Defined in: [objects/Agent.ts:317](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L317)
...
Defined in: [objects/Agent.ts:455](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L455)
...
Defined in: [objects/Agent.ts:248](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L248)
...
> **remember**(`content`, `type`): `Promise`\<[`Memory`](../interfaces/Memory.md)\>

Defined in: [objects/Agent.ts:360](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L360)
...
> **run**(`goal`): `Promise`\<[`GoalResult`](../interfaces/GoalResult.md)\>

Defined in: [objects/Agent.ts:275](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L275)
...
`Promise`\<[`GoalResult`](../interfaces/GoalResult.md)\>
...
> **searchMemories**(`query`): `Promise`\<[`Memory`](../interfaces/Memory.md)[]\>

Defined in: [objects/Agent.ts:403](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L403)
...
> `protected` **sendToChannel**(`message`, `channel`): `Promise`\<`void`\>

Defined in: [objects/Worker.ts:336](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Worker.ts#L336)
...
> **setMemory**(`memory`): `void`

Defined in: [objects/Agent.ts:227](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L227)
...
[`AgentMemory`](../../agents/interfaces/AgentMemory.md)
...
> `protected` **think**(`goal`, `observation`, `previousActions`): `Promise`\<\{ `description`: `string`; `input?`: `unknown`; `result?`: `unknown`; `tool?`: `string`; `type`: `"complete"` \| `"action"`; \}\>

Defined in: [objects/Agent.ts:330](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L330)
...
`Promise`\<\{ `description`: `string`; `input?`: `unknown`; `result?`: `unknown`; `tool?`: `string`; `type`: `"complete"` \| `"action"`; \}\>
...
> `readonly` `static` **$type**: `"Agent"` = `'Agent'`

Defined in: [objects/Agent.ts:196](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L196)
...
Defined in: [objects/Agent.ts:198](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Agent.ts#L198)
