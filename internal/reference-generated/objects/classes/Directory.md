...
[dotdo API Reference](../../README.md) / [objects](../README.md) / Directory

# Class: Directory

Defined in: [objects/Directory.ts:22](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Directory.ts#L22)
...
> **new Directory**(`ctx`, `env`): `Directory`

Defined in: [objects/Directory.ts:23](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Directory.ts#L23)
...
> **createEntry**(`entry`): `Promise`\<[`DirectoryEntry`](../interfaces/DirectoryEntry.md)\>

Defined in: [objects/Directory.ts:30](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Directory.ts#L30)
...
`Omit`\<[`DirectoryEntry`](../interfaces/DirectoryEntry.md), `"id"` \| `"createdAt"` \| `"updatedAt"`\>

#### Returns

`Promise`\<[`DirectoryEntry`](../interfaces/DirectoryEntry.md)\>

***

### createFile()

> **createFile**(`path`, `name`, `data?`): `Promise`\<[`DirectoryEntry`](../interfaces/DirectoryEntry.md)\>

Defined in: [objects/Directory.ts:193](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Directory.ts#L193)
...
> **createFolder**(`path`, `name`): `Promise`\<[`DirectoryEntry`](../interfaces/DirectoryEntry.md)\>

Defined in: [objects/Directory.ts:182](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Directory.ts#L182)
...
Defined in: [objects/Directory.ts:159](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Directory.ts#L159)
...
Defined in: [objects/Directory.ts:202](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Directory.ts#L202)
...
> **getByPath**(`path`): `Promise`\<[`DirectoryEntry`](../interfaces/DirectoryEntry.md) \| `null`\>

Defined in: [objects/Directory.ts:60](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Directory.ts#L60)
...
`Promise`\<[`DirectoryEntry`](../interfaces/DirectoryEntry.md) \| `null`\>
...
> **getEntry**(`id`): `Promise`\<[`DirectoryEntry`](../interfaces/DirectoryEntry.md) \| `null`\>

Defined in: [objects/Directory.ts:53](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Directory.ts#L53)
...
> **listChildren**(`parentPath`): `Promise`\<[`DirectoryEntry`](../interfaces/DirectoryEntry.md)[]\>

Defined in: [objects/Directory.ts:69](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Directory.ts#L69)
...
> **listRecursive**(`path`): `Promise`\<[`DirectoryEntry`](../interfaces/DirectoryEntry.md)[]\>

Defined in: [objects/Directory.ts:93](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Directory.ts#L93)
...
> **moveEntry**(`id`, `newPath`): `Promise`\<[`DirectoryEntry`](../interfaces/DirectoryEntry.md) \| `null`\>

Defined in: [objects/Directory.ts:107](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Directory.ts#L107)
...
> **rename**(`id`, `newName`): `Promise`\<[`DirectoryEntry`](../interfaces/DirectoryEntry.md) \| `null`\>

Defined in: [objects/Directory.ts:144](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Directory.ts#L144)
