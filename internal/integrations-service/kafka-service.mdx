---
title: kafka.do
description: Kafka-compatible streaming platform on Cloudflare Workers with Durable Object SQLite storage.
---
...
<Callout type="info">
Looking for KafkaJS compatibility? See [@dotdo/kafka](/docs/integrations/kafka/package) for a drop-in replacement that can also connect to real Kafka clusters.
</Callout>
...
- [@dotdo/kafka](/docs/integrations/kafka/package) - KafkaJS-compatible package
