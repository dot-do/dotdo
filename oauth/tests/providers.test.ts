...
describe('@dotdo/oauth providers', () => {
  describe('ProviderRegistry', () => {
    ...
    it('list() returns all providers', async () => {
      ...
      registry.register({ name: 'a', getAuthorizationUrl: vi.fn(), exchangeCode: vi.fn(), getUser: vi.fn() })
      registry.register({ name: 'b', getAuthorizationUrl: vi.fn(), exchangeCode: vi.fn(), getUser: vi.fn() })
    ...
    it('has() returns true for registered provider', async () => {
      ...
      registry.register({ name: 'test', getAuthorizationUrl: vi.fn(), exchangeCode: vi.fn(), getUser: vi.fn() })
