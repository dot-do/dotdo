...
/**
 * Worker node representation in the graph
 */
 ...
 */
export interface SimpleLoadBalancer {
 ...
 */
export function createGraphRoundRobinBalancer(graph: GraphEngine): SimpleLoadBalancer {
 ...
 */
export function createGraphLeastBusyBalancer(graph: GraphEngine): SimpleLoadBalancer {
  const balancer = new GraphLoadBalancer(graph)
