 ...
 *
 * Multi-provider email backend supporting MailChannels, Resend, SendGrid,
...
export class InMemoryProvider implements EmailProviderAdapter {
  readonly name: EmailProvider = 'memory'
  ...
  private initializeProviders() {
    for (const providerConfig of this.config.providers) {
      ...
      switch (providerConfig.provider) {
        case 'memory':
          this.providers.set('memory', new InMemoryProvider())
          break
        case 'mailchannels':
