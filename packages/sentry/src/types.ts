...
export interface ScopeInterface {
  ...
  setUser(user: User | null): ScopeInterface
  /** Get current user */
  getUser(): User | null
  /** Set a single tag */
  setTag(key: string, value: string): ScopeInterface
  /** Set multiple tags */
  setTags(tags: Tags): ScopeInterface
  /** Get all tags */
  getTags(): Tags
  /** Set extra data */
  setExtra(key: string, value: unknown): ScopeInterface
  /** Set multiple extras */
  setExtras(extras: Extras): ScopeInterface
  /** Get all extras */
  getExtras(): Extras
  /** Set context */
  setContext(name: string, context: Context | null): ScopeInterface
  /** Get a specific context */
  getContext(name: string): Context | undefined
  /** Get all contexts */
  getContexts(): Record<string, Context>
  /** Set severity level */
  setLevel(level: SeverityLevel): ScopeInterface
  /** Get current level */
  getLevel(): SeverityLevel | undefined
  /** Set transaction name */
  setTransactionName(name: string): ScopeInterface
  /** Get transaction name */
  getTransactionName(): string | undefined
  /** Add a breadcrumb */
  addBreadcrumb(breadcrumb: Breadcrumb, maxBreadcrumbs?: number): ScopeInterface
  /** Get all breadcrumbs */
  getBreadcrumbs(): Breadcrumb[]
  /** Clear breadcrumbs */
  clearBreadcrumbs(): ScopeInterface
  /** Set fingerprint */
...
export interface SentryClientInterface {
  ...
  captureException(exception: unknown, hint?: EventHint, scope?: ScopeInterface): string
  /** Capture a message */
  captureMessage(message: string, level?: SeverityLevel, hint?: EventHint, scope?: ScopeInterface): string
  /** Capture an event */
...
export interface Hub {
  ...
  getClient(): SentryClientInterface | undefined
