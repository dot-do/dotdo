/**
 * @dotdo/supabase-auth - Type Definitions
 *
 * Supabase Auth compatible types for the in-memory backend implementation.
 * These types mirror the @supabase/supabase-js auth types for drop-in compatibility.
 *
 * @module
 */
