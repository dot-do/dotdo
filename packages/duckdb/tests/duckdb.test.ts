...
describe('@dotdo/duckdb', () => {
  describe('Core Exports', () => {
    it('should export createDuckDB', async () => {
      const { createDuckDB } = await import('../src/index.js')
    ...
    it('should export cache management functions', async () => {
      const { clearCache, isCached } = await import('../src/index.js')
  ...
  describe('Extended Features', () => {
    it('should export createDotdoDuckDB', async () => {
      const { createDotdoDuckDB } = await import('../src/index.js')
  ...
  describe('Default Export', () => {
    it('should have default export with core functions', async () => {
      const duckdb = await import('../src/index.js')
  ...
  describe('Cache Management', () => {
    beforeEach(async () => {
      const { clearCache, clearModuleCache } = await import('../src/index.js')
      clearCache()
      clearModuleCache()
    })

    it('should start with no cached module', async () => {
      const { isCached, isModuleCached } = await import('../src/index.js')
  ...
  describe('FileBufferRegistry', () => {
    it('should create isolated registries', async () => {
      const { FileBufferRegistry } = await import('../src/index.js')
