 ...
 * for the Pusher SDK backed by in-memory pub/sub
 *
 ...
 */
export type ChannelState = 'initialized' | 'subscribing' | 'subscribed' | 'subscription_error' | 'unsubscribed'
 ...
 */
export type AuthorizerCallback = (error: Error | null, authData: AuthData | null) => void
