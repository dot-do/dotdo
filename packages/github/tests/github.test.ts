...
describe('Webhooks', () => {
  ...
  describe('parseWebhookPayload', () => {
    ...
    it('should parse pull_request event', () => {
      ...
      expect((result as any).pull_request.number).toBe(123)
    })
    ...
    it('should parse issue_comment event', () => {
      ...
      expect((result as any).comment.body).toBe('This is a comment')
    })
    ...
    it('should parse workflow_run event', () => {
      ...
      expect((result as any).workflow_run.conclusion).toBe('success')
    })
    ...
    it('should parse release event', () => {
      ...
      expect((result as any).release.tag_name).toBe('v1.0.0')
    })
  })
})
