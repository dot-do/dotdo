 ...
 *
 * Orchestrates message processing through the pipeline:
...
import type { BenthosConfig, ProcessorConfig } from './config'
...
export class PipelineExecutor {
  ...
  async processOnce(): Promise<BenthosMessage | null> {
    ...
    try {
      ...
      // Chain processors in reverse order (prepending style)
