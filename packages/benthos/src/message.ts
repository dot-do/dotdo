/**
 * BenthosMessage - Core message envelope type for @dotdo/benthos
 *
 * Provides the fundamental message abstraction with:
 * - Binary and string content
 * - Metadata key-value pairs
 * - JSON parsing with path extraction
