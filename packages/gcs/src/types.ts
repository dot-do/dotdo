...
// =============================================================================
// Buffer-like Type (for API compatibility with @google-cloud/storage)
// =============================================================================

/**
 * A Buffer-like type that extends Uint8Array with a toString method.
 * This provides API compatibility with Node.js Buffer in Cloudflare Workers.
 */
export interface GcsBuffer extends Uint8Array {
