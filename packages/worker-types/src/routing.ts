/**
 * @module routing
 * @description Worker routing and load balancing types
 *
 * Defines types for proxy configuration, load balancing, worker registration,
 * task routing, and inter-worker communication.
 */
...
export interface ClusterUtilization {
  ...
  /** Total active tasks across cluster */
  totalTasks: number
