...
// Shard context API ($.shard)
export {
  createMockContext as createShardContext,
  consistentHash,
  rangeHash,
  simpleHash,
  extractShardKey,
  type ShardContextConfig,
...
// Vector context API ($.vector)
export {
  createMockContext as createVectorContext,
  cosineSimilarity,
  euclideanDistance,
  dotProduct,
  normalizeVector,
  type VectorTier,
  type VectorContextConfig,
  type VectorBatchEntry,
...
export {
  ...
  type DataStorage,
  // Re-exports from specialized namespaces
  createTrackContext,
  createMeasureNamespace,
