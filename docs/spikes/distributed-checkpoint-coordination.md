...
### Codebase References
- `/Users/nathanclevenger/projects/dotdo/db/primitives/stateful-operator/index.ts` - Existing checkpoint primitives
- `/Users/nathanclevenger/projects/dotdo/db/primitives/stateful-operator/backends/do-backend.ts` - DO state backend
- `/Users/nathanclevenger/projects/dotdo/objects/CrossDOTransaction.ts` - Cross-DO transaction patterns
- `/Users/nathanclevenger/projects/dotdo/objects/persistence/checkpoint-manager.ts` - Single-DO checkpoint manager
- `/Users/nathanclevenger/projects/dotdo/db/primitives/exactly-once-context.ts` - Exactly-once processing context
- `/Users/nathanclevenger/projects/dotdo/docs/spikes/cross-do-join-latency.md` - Cross-DO latency analysis
