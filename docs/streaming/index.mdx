...
| Component | Purpose |
|-----------|---------|
| [WebSocketHub](/docs/streaming/websocket-hub) | Connection management, rooms, and broadcasting |
| [SSE Streaming](/docs/streaming/sse) | Server-Sent Events for unidirectional updates |
| [BackpressureController](/docs/streaming/backpressure) | Flow control with pause/drop/buffer modes |
| [RateLimiter](/docs/streaming/rate-limiting) | Token bucket algorithm for rate limiting |
| [SubscriptionManager](/docs/streaming/pub-sub) | Topic-based publish/subscribe patterns |
...
All streaming components are designed to work within Durable Objects, leveraging their built-in WebSocket hibernation and single-threaded execution model:
...
- [WebSocket Hub](/docs/streaming/websocket-hub) - Connection management and rooms
- [SSE Streaming](/docs/streaming/sse) - Server-Sent Events
- [Backpressure](/docs/streaming/backpressure) - Flow control strategies
- [Rate Limiting](/docs/streaming/rate-limiting) - Token bucket algorithm
- [Pub/Sub](/docs/streaming/pub-sub) - Topic-based subscriptions
