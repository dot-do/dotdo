...
[dotdo API Reference](../../README.md) / [objects](../README.md) / DO

# Class: DO\<E\>

Defined in: [objects/DOFull.ts:431](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/DOFull.ts#L431)
...
- [`SandboxDO`](SandboxDO.md)

## Type Parameters

### E

`E` *extends* [`Env`](../type-aliases/Env.md) = [`Env`](../type-aliases/Env.md)
...
`DOBase.lastCheckpointTimestamp`
...
> **new DO**\<`E`\>(`ctx`, `env`): `DO`\<`E`\>

Defined in: [objects/DOBase.ts:1062](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/DOBase.ts#L1062)
...
`DOBase._initializeEagerFeatures`
...
`DOBase.deriveIdentityFromRequest`
...
`DOBase.dispatchEventToHandlers`
...
`DOBase.extractBearerTokenFromProtocol`
...
`DOBase.getHandlerRegistrations`
