...
[dotdo API Reference](../../README.md) / [objects](../README.md) / Workflow

# Class: Workflow

Defined in: [objects/Workflow.ts:201](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L201)
...
> **new Workflow**(`ctx`, `env`): `Workflow`

Defined in: [objects/Workflow.ts:210](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L210)
...
Defined in: [objects/Workflow.ts:254](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L254)
...
> `protected` **executeInstance**(`instance`): `Promise`\<`void`\>

Defined in: [objects/Workflow.ts:493](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L493)
...
> `protected` **executeStep**(`stepDef`): `Promise`\<`unknown`\>

Defined in: [objects/Workflow.ts:596](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L596)
...
Defined in: [objects/Workflow.ts:756](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L756)
...
> **getConfig**(): `Promise`\<[`WorkflowConfig`](../interfaces/WorkflowConfig.md) \| `null`\>

Defined in: [objects/Workflow.ts:221](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L221)

Get workflow configuration from graph

#### Returns

`Promise`\<[`WorkflowConfig`](../interfaces/WorkflowConfig.md) \| `null`\>
...
> **getFailedSteps**(): `Promise`\<`object`[]\>

Defined in: [objects/Workflow.ts:706](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L706)
...
> **getInstance**(`instanceId`): `Promise`\<[`WorkflowInstance`](../interfaces/WorkflowInstance.md) \| `null`\>

Defined in: [objects/Workflow.ts:648](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L648)
...
> **getInstancesByStatus**(`status`): `Promise`\<[`WorkflowInstance`](../interfaces/WorkflowInstance.md)[]\>

Defined in: [objects/Workflow.ts:698](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L698)
...
> **listInstances**(`limit`): `Promise`\<[`WorkflowInstance`](../interfaces/WorkflowInstance.md)[]\>

Defined in: [objects/Workflow.ts:667](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L667)
...
> **pauseInstance**(`instanceId`): `Promise`\<[`WorkflowInstance`](../interfaces/WorkflowInstance.md) \| `null`\>

Defined in: [objects/Workflow.ts:724](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L724)
...
> **resumeInstance**(`instanceId`): `Promise`\<[`WorkflowInstance`](../interfaces/WorkflowInstance.md) \| `null`\>

Defined in: [objects/Workflow.ts:738](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L738)
...
> **sendEvent**(`instanceId`, `eventType`, `payload`): `Promise`\<`void`\>

Defined in: [objects/Workflow.ts:621](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L621)
...
> **start**(`input`): `Promise`\<[`WorkflowInstance`](../interfaces/WorkflowInstance.md)\>

Defined in: [objects/Workflow.ts:370](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Workflow.ts#L370)
...
> `readonly` `static` **$type**: `string` = `'DO'`

Defined in: [objects/DOTiny.ts:206](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/DOTiny.ts#L206)
