...
[dotdo API Reference](../../README.md) / [objects](../README.md) / Product

# Class: Product

Defined in: [objects/Product.ts:32](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Product.ts#L32)
...
> **new Product**(`ctx`, `env`): `Product`

Defined in: [objects/Product.ts:35](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Product.ts#L35)
...
> **addVariant**(`variant`): `Promise`\<[`ProductVariant`](../interfaces/ProductVariant.md)\>

Defined in: [objects/Product.ts:73](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Product.ts#L73)
...
`Omit`\<[`ProductVariant`](../interfaces/ProductVariant.md), `"id"`\>

#### Returns

`Promise`\<[`ProductVariant`](../interfaces/ProductVariant.md)\>
...
> **checkInventory**(`variantId`): `Promise`\<\{ `available`: `boolean`; `quantity`: `number`; \}\>

Defined in: [objects/Product.ts:126](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Product.ts#L126)
...
Defined in: [objects/Product.ts:52](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Product.ts#L52)
...
Defined in: [objects/Product.ts:185](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Product.ts#L185)
...
> **getLowestPrice**(): `Promise`\<`number` \| `null`\>

Defined in: [objects/Product.ts:178](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Product.ts#L178)
...
> **getProductConfig**(): `Promise`\<[`ProductConfig`](../interfaces/ProductConfig.md) \| `null`\>

Defined in: [objects/Product.ts:42](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Product.ts#L42)

Get product configuration

#### Returns

`Promise`\<[`ProductConfig`](../interfaces/ProductConfig.md) \| `null`\>
...
> **releaseInventory**(`variantId`, `quantity`): `Promise`\<`void`\>

Defined in: [objects/Product.ts:163](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Product.ts#L163)
...
> **removeVariant**(`variantId`): `Promise`\<`boolean`\>

Defined in: [objects/Product.ts:109](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Product.ts#L109)
...
> **reserveInventory**(`variantId`, `quantity`): `Promise`\<`boolean`\>

Defined in: [objects/Product.ts:142](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Product.ts#L142)
...
Defined in: [objects/Product.ts:61](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Product.ts#L61)
...
> **updateVariant**(`variantId`, `updates`): `Promise`\<[`ProductVariant`](../interfaces/ProductVariant.md) \| `null`\>

Defined in: [objects/Product.ts:92](https://github.com/dot-do/dotdo/blob/133603bf4355865921df6b01abcbf5c1d8e815f0/objects/Product.ts#L92)
...
`Partial`\<[`ProductVariant`](../interfaces/ProductVariant.md)\>

#### Returns

`Promise`\<[`ProductVariant`](../interfaces/ProductVariant.md) \| `null`\>
