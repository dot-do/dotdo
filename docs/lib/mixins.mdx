---
title: DO Mixins
description: Capability mixins for Durable Objects - filesystem, git, bash, and npm
---

# DO Mixins

Mixins extend Durable Objects with additional capabilities. Apply them to add `$.fs`, `$.git`, `$.bash`, and `$.npm` to your workflow context.

## Overview

```typescript
import { DO } from 'objects/DO'
import { withFs, withGit, withBash, withNpm } from 'lib/mixins'
