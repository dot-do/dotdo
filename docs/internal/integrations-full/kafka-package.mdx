...
<Callout type="info">
Looking for managed streaming without infrastructure? See [kafka.do](/docs/integrations/kafka/service) for a fully managed Kafka-compatible service on the edge.
</Callout>
...
- [kafka.do](/docs/integrations/kafka/service) - Managed Kafka-compatible streaming
