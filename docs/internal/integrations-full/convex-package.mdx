...
<Callout type="info">
Looking for a fully managed service? See [convex.do](/docs/integrations/convex/service) for production edge deployment with advanced features.
</Callout>
...
The SDK is ideal for unit tests - no external Convex required:
...
- [convex.do](/docs/integrations/convex/service) - Managed Convex on the edge
