...
<Callout type="info">
Looking for managed webhook handling and analytics? See [twilio.do](/docs/integrations/twilio/service) for a fully managed Twilio service on the edge.
</Callout>
...
## Testing with @dotdo/twilio

The package is ideal for unit tests - no real API calls required:
...
describe('NotificationService', () => {
  ...
  beforeEach(() => {
    ...
    client = twilio('ACtest123456789', 'test_auth_token')
  })
...
- [twilio.do](/docs/integrations/twilio/service) - Managed Twilio service on the edge
