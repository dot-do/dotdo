...
<Callout type="info">
Looking for a managed production service? See [sentry.do](/docs/integrations/sentry/service) for an edge-optimized Sentry proxy with automatic batching and retries.
</Callout>
...
Your existing Sentry code works unchanged:
...
- [sentry.do](/docs/integrations/sentry/service) - Managed Sentry on the edge
