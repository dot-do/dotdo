...
- [Cron Hibernation](./cron-hibernation.md) - Alarm patterns for scheduling with hibernation
- [Checkpoint Size Limits](./checkpoint-size-limits.md) - Storage strategies for checkpoints
- [Distributed Checkpoint Coordination](./distributed-checkpoint-coordination.md) - Multi-DO checkpoint coordination
- [Long-Running Tasks](./long-running-tasks.md) - Task durability and resumption patterns

### Related Architecture Documents

- [Architecture Overview](../architecture.md) - Main architecture documentation
- [DOBase Decomposition](../architecture/dobase-decomposition.md) - EventsModule and state persistence
