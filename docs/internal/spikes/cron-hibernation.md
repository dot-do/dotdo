...
- `workflows/schedule-builder.ts` - Schedule builder implementation
- `workflows/ScheduleManager.ts` - Schedule manager
- `objects/primitives/alarm-adapter.ts` - Alarm adapter
- `db/primitives/dag-scheduler/index.ts` - DAG scheduler
...
- [Exactly-Once Hibernation](./exactly-once-hibernation.md) - Exactly-once semantics with hibernation gaps
- [Long-Running Tasks](./long-running-tasks.md) - Task coordination exceeding CPU limits
- [Distributed Checkpoint Coordination](./distributed-checkpoint-coordination.md) - Coordinating checkpoints with scheduling

### Related Architecture Documents

- [Architecture Overview](../architecture.md) - Main architecture documentation
- [DOBase Decomposition](../architecture/dobase-decomposition.md) - SchedulingModule extraction
