...
Workflow compat layers have been moved to the [compat repo](https://github.com/dotdo/compat).

| Platform | Package | Description |
|----------|---------|-------------|
| **Temporal** | `@dotdo/compat-temporal` | Temporal workflow compatibility |
| **Inngest** | `@dotdo/compat-inngest` | Inngest event functions compatibility |
| **QStash** | `@dotdo/compat-qstash` | Upstash QStash compatibility |
| **Trigger.dev** | `@dotdo/compat-trigger` | Trigger.dev compatibility |
