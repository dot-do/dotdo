...
<Callout type="info" title="Start with the Mental Model">
For a conceptual introduction to why promise pipelining works and visual diagrams of the optimization, start with [Understanding Promise Pipelining](/docs/rpc/understanding-promise-pipelining).
</Callout>
...
For the definitive decision tree on when to await, see [When to Await](/docs/rpc/when-to-await).
