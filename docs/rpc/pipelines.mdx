...
For debugging, you can inspect the pipeline before execution:
...
console.log(deployed._pipeline)
// {
//   nodes: [
...
5. **Profile your pipelines** - Use `._pipeline` to verify your code creates the graph you expect.
