...
<Cards>
  <Card title="Security Hardening" href="/docs/security/hardening">
    Technical security practices, OWASP guidelines, and deployment checklists.
  </Card>
  ...
  <Card title="Encryption" href="/docs/security/encryption">
    Data protection at rest, in transit, and key management.
  </Card>
  ...
  <Card title="Secrets Management" href="/docs/security/secrets">
    Environment variables, vault integration, and rotation.
  </Card>
  <Card title="Compliance" href="/docs/security/compliance">
    GDPR, SOC 2, data residency, and audit logging.
  </Card>
</Cards>
...
<Cards>
  <Card title="Human Escalation" href="/docs/humans">
    Human-in-the-loop workflows with full audit trails.
  </Card>
  <Card title="Platform" href="/docs/platform">
    Platform services, compliance, and audit logging.
  </Card>
  <Card title="Agents" href="/docs/agents">
    AI agents with verifiable identity and traceable actions.
  </Card>
  <Card title="Architecture" href="/docs/architecture">
    Technical deep dive into V8 isolates and DO security model.
  </Card>
</Cards>
