...
dotdo runs on Cloudflare's edge network: 300+ cities, 0ms cold starts, V8 isolates with persistent state. This section covers the scaling primitives that let you grow from a single Durable Object to a globally distributed system.
