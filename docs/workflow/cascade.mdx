...
description: Automatic escalation from code to generative to agentic to human tiers
---

# Cascade Execution

The cascade system automatically escalates tasks through execution tiers until one succeeds with sufficient confidence. It implements the pattern: **code -> generative -> agentic -> human**.
