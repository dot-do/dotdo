...
<Cards>
  <Card title="Storage Hierarchy" href="/docs/storage/hierarchy">
    Complete guide explaining how ThingsStore, R2, Parquet, and Iceberg work together.
  </Card>
</Cards>
...
- [Storage Hierarchy](/docs/storage/hierarchy) - Complete guide to the storage architecture
