...
await client.transaction(async (tx) => {
  await tx.queueEmail({ to: 'user1@example.com', from: 'noreply@example.com', subject: 'Update', text: '...' })
  await tx.queueEmail({ to: 'user2@example.com', from: 'noreply@example.com', subject: 'Update', text: '...' })
})
await client.flush()
