...
<Callout type="info">
Looking for a fully managed edge email service? See [sendgrid.do](/docs/integrations/sendgrid/service) for production deployments with zero infrastructure.
</Callout>

## Why @dotdo/sendgrid?

| Feature | SendGrid | @dotdo/sendgrid |
|---------|----------|-----------------|
...
## Testing with @dotdo/sendgrid

The package is ideal for unit tests - mock SendGrid without external dependencies:
...
describe('EmailService', () => {
  ...
  beforeEach(() => {
    // Point to local DO for email capture
  ...
  it('should send welcome email', async () => {
    ...
    // Emails captured locally, not sent to SendGrid
  })
})
```
...
- [sendgrid.do](/docs/integrations/sendgrid/service) - Managed email on the edge
