...
Drop-in replacement for `postmark`. Your existing `postmark` code works unchanged - just swap the import.
...
| **Deliverability** | Same + edge benefits | Industry-leading |
