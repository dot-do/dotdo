...
try {
  ...
  if (error instanceof ObjectNotFoundError) {
    console.error('Object not found:', error.objectID)
    ...
    console.error('Invalid filter syntax:', error.filter)
...
|------------|-------------|
| `AlgoliaError` | Base error for all Algolia operations |
| `ObjectNotFoundError` | Object with specified objectID not found |
| `IndexNotFoundError` | Index does not exist |
| `InvalidFilterError` | Filter syntax is invalid |
| `InvalidSettingsError` | Settings configuration is invalid |
