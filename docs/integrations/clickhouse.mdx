---
title: ClickHouse
description: ClickHouse-compatible analytics engine with edge compatibility and MergeTree-style tables.
---

# ClickHouse

ClickHouse-compatible analytics engine that runs entirely in-memory on the edge. Provides SQL interface, MergeTree tables, and OLAP aggregations.

```typescript
// Import from the dotdo compat layer
...
| ClickHouse | dotdo/db/compat/clickhouse |
|------------|-------------------|
...
**This is an in-memory analytics compatibility layer.** It provides ClickHouse-compatible SQL and table APIs that run entirely in-memory on the edge. This is ideal for request-scoped analytics, aggregations, and OLAP operations.
...
```typescript
import { ClickHouseClient } from 'dotdo/db/compat/clickhouse'
...
```typescript
import { MergeTreeTable } from 'dotdo/db/compat/clickhouse'
...
```typescript
import { MergeTreeTable, MaterializedView } from 'dotdo/db/compat/clickhouse'
