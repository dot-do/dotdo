...
```typescript
import { EmbedBuilder, EmbedColors } from '@dotdo/discord'
...
// Preset embeds for common cases
import { createSuccessEmbed, createErrorEmbed, createWarningEmbed } from '@dotdo/discord'

const success = createSuccessEmbed('Operation completed!')
const error = createErrorEmbed('Something went wrong')
const warning = createWarningEmbed('Be careful!')
```
