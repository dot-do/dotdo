...
| Elasticsearch | dotdo/compat/elasticsearch |
|---------------|----------------------------|
...
The Elasticsearch compat layer is included in the dotdo package:
...
import type {
  ...
  InfoResponse,
} from 'dotdo/compat/elasticsearch'
...
```typescript
import { ResponseError, NotFoundError, ConflictError, BadRequestError } from 'dotdo/compat/elasticsearch'
...
**Category Overview:**
- [Search SDKs](/docs/compat/search) - Architecture overview for all search SDKs including Elasticsearch, Algolia, Meilisearch, Typesense, and Orama

**Other Search Integrations:**
- [Algolia](/docs/integrations/algolia) - Algolia InstantSearch compatibility

**Related Integrations:**
- [Pinecone](/docs/integrations/pinecone) - Vector search for embeddings
