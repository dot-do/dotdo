---
title: "@dotdo/discord"
description: Discord.js-compatible package for edge environments with webhook-based interactions.
---

# @dotdo/discord

Drop-in replacement for Discord.js bot development optimized for edge runtimes. Your existing `discord.js` code patterns work unchanged - just swap the import.
...
<Callout type="info">
Looking for a managed solution with persistent state? See [discord.do](/docs/integrations/discord/service) for a fully managed Discord bot platform on the edge.
</Callout>
...
## Testing with @dotdo/discord

The package is ideal for unit tests - no Discord server required:
...
describe('Discord Bot', () => {
  it('should build slash command correctly', () => {
    const command = new SlashCommandBuilder()
      .setName('test')
      .setDescription('A test command')
      .addStringOption(opt => opt.setName('input').setDescription('Input value'))
...
- [discord.do](/docs/integrations/discord/service) - Managed Discord bot platform on the edge
