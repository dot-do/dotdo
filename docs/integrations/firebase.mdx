...
For testing and development, the SDK uses in-memory storage backed by Durable Object SQLite. No Firebase project or emulator required.
...
```typescript
import { getFirestore, collection, onSnapshot, addDoc } from '@dotdo/firebase'
...
```typescript
import { getFirestore, doc, setDoc, runTransaction } from '@dotdo/firebase'
...
## Outbound Mode - Connecting to Real Firebase

For production, connect to your actual Firebase project:
...
// All operations go to real Firebase
...
### Extended Configuration for Durable Objects
