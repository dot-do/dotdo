...
$.emit.Customer.signup({ id: 'cust-123', email: 'alice@example.com' })
...
$.emit.Invoice.sent({ invoiceId: 'inv-001', recipientEmail: 'bob@example.com' })
...
```typescript
// You emit:
$.emit.Customer.signup({ email: 'alice@example.com' })
