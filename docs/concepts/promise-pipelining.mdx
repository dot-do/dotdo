...
For the complete mental model and detailed patterns, see the RPC documentation:

<Cards>
  <Card title="Understanding Promise Pipelining" href="/docs/rpc/understanding-promise-pipelining">
    The essential guide: mental model, visual diagrams, and why unawaited promises eliminate round trips.
  </Card>
