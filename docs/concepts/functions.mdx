...
Three levels of execution durability via the WorkflowContext (`$`):
...
- [Functions Guide](/docs/functions) - Creating and composing functions
- [Agents](/docs/agents) - AI agents for agentic functions
- [Humans](/docs/humans) - Human-in-the-loop functions and escalation
- [Workflows](/docs/workflows) - Durable workflow orchestration with the $ context DSL
- [WorkflowContext](/docs/sdk/workflow-context) - The $ proxy for workflow operations
