...
console.log(customer.$id)   // 'https://app.example.com.ai/Customer/cust-123'
...
console.log(thing.identity.ns)     // 'https://app.example.com.ai'
...
```
https://app.example.com.ai/Customer/cust-123
└──────────┬─────────────┘└──┬───┘└──┬────┘
         namespace        type      id
```
...
const customer = await things.create({
  $id: 'https://app.example.com.ai/Customer/cust-123',
  $type: 'Customer',
  name: 'Alice',
...
// order.$id = 'https://app.example.com.ai/Order/a1b2c3d4'
```
...
const customer = await things.create({
  name: 'Alice',
  data: { email: 'alice@example.com.ai', plan: 'starter' }
})
...
console.log(updated.data.email) // 'alice@example.com.ai' (preserved)
```
