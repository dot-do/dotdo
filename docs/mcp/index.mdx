...
```
do://inventory.example.com.ai/items
do://inventory.example.com.ai/items/item-123
do://inventory.example.com.ai/categories
```
...
```json
{
  ...
  "result": {
    "resources": [
      {
        "uri": "do://inventory.example.com.ai/items",
        "name": "items",
        "mimeType": "application/json"
      },
      {
        "uri": "do://inventory.example.com.ai/categories",
        "name": "categories",
        "mimeType": "application/json"
      }
    ]
...
```json
{
  ...
  "method": "resources/read",
  "params": {
    "uri": "do://inventory.example.com.ai/items/1"
  }
}
```
