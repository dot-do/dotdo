 ...
 * for the MySQL SDK backed by Durable Objects
 *
...
/**
 * MySQL-compatible value types
 */
export type Value = null | string | number | boolean | Date | Buffer | object

/**
 * Query parameter values - MySQL uses ? placeholders
 */
 ...
 */
export interface ExtendedMySQLConfig extends PoolOptions {
 ...
 * Connection error
 */
export class ConnectionError extends MySQLError {
