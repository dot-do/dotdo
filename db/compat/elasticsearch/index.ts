...
// Re-export DSL parser for advanced query parsing/analysis
export {
  EsDslParser,
  createDslParser,
  defaultParser,
  ...
  type NormalizedMultiMatchClause,
  type NormalizedTermClause,
  type NormalizedTermsClause,
  type NormalizedRangeClause,
  type NormalizedExistsClause,
  type NormalizedPrefixClause,
  type NormalizedWildcardClause,
  type NormalizedIdsClause,
  type NormalizedMatchPhraseClause,
  type NormalizedMatchAllClause,
  type NormalizedMatchNoneClause,
  type NormalizedAggregation,
  type NormalizedTermsAgg,
  type NormalizedHistogramAgg,
  type NormalizedDateHistogramAgg,
  type NormalizedRangeAgg,
  type NormalizedMetricAgg,
  type NormalizedStatsAgg,
  type NormalizedPercentilesAgg,
  type NormalizedTopHitsAgg,
  type NormalizedFilterAgg,
  type NormalizedSort,
  type NormalizedSortItem,
  type NormalizedPagination,
  type NormalizedSourceFilter,
  type QueryAnalysis,
} from './dsl-parser'
