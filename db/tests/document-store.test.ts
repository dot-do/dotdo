...
describe('DocumentStore - RED Phase', () => {
  ...
  describe('Time Travel Queries', () => {
    // Skip: Time travel requires event sourcing / version history table
    // This is marked as TBD in the README implementation status
    it.skip('should retrieve document as of specific timestamp', async () => {
      const customer = await docs.create({
        name: 'Time Travel',
