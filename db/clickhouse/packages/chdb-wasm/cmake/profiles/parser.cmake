# parser.cmake
# SQL Parser Only WASM Build Profile (chdb-parser.wasm)
#
# Target: ~300KB
# Use case: SQL validation, IDE integration, syntax checking
#
# This profile builds ONLY the SQL lexer and parser components.
...
#
# Usage:
#   cmake -C cmake/profiles/parser.cmake \
...
message(STATUS "")
message(STATUS "================================================================")
message(STATUS "  PARSER Profile - chdb-parser.wasm")
message(STATUS "  Target: ~300KB")
...
set(CHDB_PROFILE "parser" CACHE STRING "Build profile name" FORCE)
set(CHDB_PROFILE_OUTPUT_NAME "chdb-parser" CACHE STRING "Output WASM filename" FORCE)
set(CHDB_PROFILE_SIZE_TARGET "~300KB" CACHE STRING "Target binary size" FORCE)
set(CHDB_PROFILE_DESCRIPTION "SQL lexer and parser only - SQL validation" CACHE STRING "" FORCE)
...
# Ultra-aggressive size optimization for parser-only build
...
set(CHDB_WASM_LINK_FLAGS
    ...
    "-sALLOW_MEMORY_GROWTH=0"        # Fixed memory for smaller size
    "-sINITIAL_MEMORY=4194304"       # 4MB initial (sufficient for parser)
...
message(STATUS "")
message(STATUS "================================================================")
message(STATUS "  PARSER Profile Configuration Summary")
message(STATUS "================================================================")
message(STATUS "")
message(STATUS "Output Name:         chdb-parser.wasm")
message(STATUS "Target Size:         ~300KB")
message(STATUS "")
message(STATUS "ENABLED:")
message(STATUS "  - SQL Lexer (tokenization)")
message(STATUS "  - SQL Parser (AST generation)")
message(STATUS "  - SQL syntax validation")
message(STATUS "  - SQL pretty-printing/formatting")
message(STATUS "  - Query type detection")
message(STATUS "")
...
message(STATUS "  - SQL editor syntax highlighting")
message(STATUS "  - IDE autocomplete integration")
message(STATUS "  - SQL linting and validation")
message(STATUS "  - Query formatting tools")
message(STATUS "")
message(STATUS "================================================================")
message(STATUS "")
