# dashboard.cmake
# Dashboard WASM Build Profile (chdb-dashboard.wasm)
#
# Target: ~3MB
# Use case: Simple dashboards, small data visualizations
#
# This profile provides a lightweight SQL execution environment optimized for
# dashboard-style analytics with basic aggregates and common formats.
#
# Features:
...
#
# Usage:
#   cmake -C cmake/profiles/dashboard.cmake \
...
message(STATUS "")
message(STATUS "================================================================")
message(STATUS "  DASHBOARD Profile - chdb-dashboard.wasm")
message(STATUS "  Target: ~3MB")
...
set(CHDB_PROFILE "dashboard" CACHE STRING "Build profile name" FORCE)
set(CHDB_PROFILE_OUTPUT_NAME "chdb-dashboard" CACHE STRING "Output WASM filename" FORCE)
set(CHDB_PROFILE_SIZE_TARGET "~3MB" CACHE STRING "Target binary size" FORCE)
set(CHDB_PROFILE_DESCRIPTION "Memory engine + basic aggregates for dashboards" CACHE STRING "" FORCE)
...
message(STATUS "[Formats] Parquet, Arrow, Avro, Protobuf DISABLED")
...
set(CHDB_COMPRESSION_ZSTD OFF CACHE BOOL "Disable ZSTD" FORCE)
...
message(STATUS "[WASM] Emscripten flags configured for dashboard output")
...
message(STATUS "")
message(STATUS "================================================================")
message(STATUS "  DASHBOARD Profile Configuration Summary")
message(STATUS "================================================================")
message(STATUS "")
message(STATUS "Output Name:         chdb-dashboard.wasm")
message(STATUS "Target Size:         ~3MB")
message(STATUS "")
...
message(STATUS "  - Simple dashboards and reports")
message(STATUS "  - Small data analytics (<100K rows)")
message(STATUS "  - Basic data visualization")
message(STATUS "  - Lightweight embedded analytics")
message(STATUS "")
message(STATUS "================================================================")
message(STATUS "")
