 ...
 *
 * Uses btoa() which is available in all modern JavaScript runtimes:
 * - All browsers
 * - Node.js 16+ (global)
 * - Cloudflare Workers
 * - Deno
 ...
 *
 * Uses atob() which is available in all modern JavaScript runtimes:
 * - All browsers
 * - Node.js 16+ (global)
 * - Cloudflare Workers
 * - Deno
 ...
 */
export function applyCursorPagination(items, options, sortField, sortDirection, getId, getSortValue) {
